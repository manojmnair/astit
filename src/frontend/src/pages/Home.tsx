                                        ...
                                        <div className="w-full sm:w-1/2 lg:w-1/2">
                                            <div className="m-3">
                                                ...
                                                <div className="features-content">
                                                    <h4 className="feature-title">Astit Finance</h4>
                                                    <p> Astit Finance is a Decentralized Finance (DeFi) platform built on top of the ICP. It aims at creating a platform for RWA creation using  yield bearing assets such as T-bills, corporate bonds, etc. , gold and cryptocurrency assets. It also aims at providing trading these assets.
</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="w-full sm:w-1/2 lg:w-1/2">
                                            <div className="m-3">
                                                ...
                                                <div className="features-content">
                                                    ...
                                                    <p> Astit finance helps in providing lending keeping the tokens as collateral.</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="w-full sm:w-1/2 lg:w-1/2">
                                            <div className="m-3">
                                                ...
                                                <div className="features-content">
                                                    <p> Astit finance aims at creating tokens compliance with rules and regulations.</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="w-full sm:w-1/2 lg:w-1/2">
